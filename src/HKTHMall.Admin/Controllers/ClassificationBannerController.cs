...
{
      [UserAuthorize]
    public class ClassificationBannerController :  HKBaseController
    {
        ...
        public ClassificationBannerController(IbannerService bannerService, IbannerProductService bannerProductService)
        {
        ...
        public JsonResult List(SearchbannerModel model)
        {
            ...
            model.IdentityStatus =  model.IdentityStatus;
