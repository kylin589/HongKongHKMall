...
{
      [UserAuthorize]
    public class BannerController : HKBaseController
    {
        ...
        public BannerController(IbannerService bannerService, IbannerProductService bannerProductService)
        {
        ...
        public ActionResult Index()//int? IdentityStatus
        {
            ...
            ViewBag.titleName = con.GetIdentityStatusName(1);//IdentityStatus.HasValue == true ? IdentityStatus.Value : 1
            ViewBag.dentityStatus = 1;//IdentityStatus.HasValue == true ? IdentityStatus.Value : 1
            return View();
        }
        ...
        public ActionResult BannerCreate(long? id)
        {
            ...
            //2015-9-22 wuyf 这里identityStatus默认是1，不公用一个页面了
            //ViewData["BannerPlaceCodeModel1"] = null;
            //if ( identityStatus == 2)
            //{
            //    ViewData["BannerPlaceCodeModel1"] = con.GetBannerProducPlaceCodeNameList(CultureHelper.GetLanguageID, 0, identityStatus);
            //}
