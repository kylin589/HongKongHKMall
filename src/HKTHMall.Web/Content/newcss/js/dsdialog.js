;(function(global, document, $, undefined,options) {
	var view = $(global),
		DOC = $(document),
	...
	Dialog.prototype = {
		...
		_getElem: function(ops) {
			...
			$(".dialogSubmit").on('click',function(){
				if (ops.tijiao === true || typeof ops.tijiao === 'function') {
					ops.tijiao.call(this);
				}
			});
		...
		padding: function(padding) {
			this.contentShell.css('padding', '0 30px 25px');
			return this;
		},
		follow: (function() {
			var _offsetMaps = {
	...
	$('.dialogSubmit').eq(0).click(function(){
		debugger;
		console.log("123");
		tijiao();
	});
	...
	$.extend(Dialog.onSubmit, (function() {
	...
	$.extend(ds.dialog, {
		...
		onSubmit:function(content,tijiao){
			return new Dialog({
				id: 'ds_dialog',
				fixed: true,
				left: '50%',
...
//$(function () {
//    if ($('.ds_dialog_title>h3').text() == "") {
//        $('.ds_dialog_title').css('borderBottom', '0');
//    } else {
//        $('.ds_dialog_title').css('borderBottom', '1px solid #dcdcdc');
//    }
//});