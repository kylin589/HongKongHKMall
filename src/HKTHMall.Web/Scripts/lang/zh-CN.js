...
var commonLang = ({
    ...
    ACCOUNT_MY_ACCOUNTRECHARGE_TOPAMOUNT: "充值金额必须处于100-1000000 港元之间！",
    ...
    LOGIN_GETPASSWORD_GETAGAIN: "{0}秒后重新获取",
    ...
    LOGIN_GETPASSWORD_PWDFORMAT: "密码由8-16位数字、字母或特殊字符组成,区分大小写",
    ...
    MONEY_ORDER_SETPAYPASSWORD: "请设置交易密码",
    MONEY_ORDER_INSUFFICIENT_BALANCE: "余额不足",
    ...
    REGISTERNOW: "立即注册",
    UPLOAD_TEXT: "上传图像",
    UPLOAD_FLASH_CONTROL: "您未安装FLASH控件,无法上传图片！请安装FLASH控件后再试",
    UPLOAD_SELECT_LIMIT: "数量超出限制,最多选择1个文件",
    UPLOAD_SIZE_LIMIT: "文件大小超过{0}限制,请重新上传",
    UPLOAD_WROMH_SIZE: "文件大小异常",
    UPLOAD_WRONG_TYPE: "文件类型不正确",
    UPLOAD_TIP_ONE: "2M以内的jpg,png,gif,jpeg格式的图片",
    UPLOAD_TIP_TWO: "推荐尺寸300*300像素",
    INPUT_PHONECODE: "请输入手机验证码",
    INPUT_OLD_LOGINPWD: "请输入原始登录密码",
    INPUT_NEW_LOGINPWD: "请输入登录密码",
    INPUT_OLD_JIAOYIMIMA: "请输入原始交易密码",
    PAYPASSWORD_PWDFORMAT: "密码由8-16位数字、字母或特殊字符组成,区分大小写",
    HOME_INDEX_START: "开始",
    HOME_INDEX_SHENGYU: "剩余",
    HOME_INDEX_OVER: "结束",
    SUBMIT_SUCCESS: "提交成功",
    SUBMIT_FAIL: "提交失败",
    ENETR_CONSU_CONTENT: "请填写咨询内容",
    LOGIN_FIRST: "请先登录",
    SHOPPINGCART_WUHUO: "无货",
    SHOPPINGCART_YIXIAJIA: "已下架",
    YEAR: "年",
    MONTH: "月",
    DAY: "日",
    LanguageID: "1",
    HOME_SHOPPINGCART_CARTISNULL: "购物车空空的哦~，去看看心仪的商品吧~",
    HOME_SHOPPINGCART_GOSHOPPING: "去购物",
    MESSAGEBOX_SURE: "确定",
