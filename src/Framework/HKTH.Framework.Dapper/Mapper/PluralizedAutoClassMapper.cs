...
namespace HKTH.Framework.Dapper.Mapper
{
	...
	public class PluralizedAutoClassMapper<T> : AutoClassMapper<T> where T : class
	{
		...
		public static class Formatting
		{
			...
			private static readonly IDictionary<string, string> Pluralizations = new Dictionary<string, string> {// Start with the rarest cases, and move to the most common
				{"person", "people"}, {"ox", "oxen"}, {"child", "children"}, {"foot", "feet"}, {"tooth", "teeth"}, {"goose", "geese"},
